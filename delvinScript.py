...
if os.path.exists("delvin_yamoah"):
    try:
        shutil.rmtree("delvin_yamoah")
        print(f"Directory '{'delvin_yamoah'}' has been removed successfully.")
    except Exception as e:
        print(f"Error: {e}")

download_folder = "delvin_yamoah"

if not os.path.exists(download_folder):
    os.makedirs(download_folder)
    print(f"Directory: {download_folder} created.")

local_file_path = os.path.join(download_folder, "delvin_yamoah.txt")
